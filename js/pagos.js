$(document).ready(function () {
   ...
   $('#havertz').on('show.bs.modal', (e) => {
      ...
      if (!form.checkValidity()) {
         ...
         Swal.fire({
            icon: "error",
            title: "no quiero (voz de alex cuca)",
            text: "los campos estan vacìos, debe llenar todos los campos!",
